...
struct KeybindConflictsTests {
    ...
    @Test func moveWindowKeyRejectsReservedSessionKeys() {
        withDefaults({}) {
            ...
            Defaults[.windowSwitcherSelectionKeyCode] = UInt16(kVK_Space)
            #expect(KeybindConflicts.validateSpaceMoveWindowKey(UInt16(kVK_Return)) != nil, "Return always commits")
            #expect(KeybindConflicts.validateSpaceMoveWindowKey(UInt16(kVK_Space)) != nil, "custom selection key")
            Defaults[.windowSwitcherSelectionKeyCode] = UInt16(kVK_Return)
